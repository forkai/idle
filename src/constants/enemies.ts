...
export const MONSTERS: Record<string, Monster> = {
  ...
  forest_wolf: {
    ...
    stats: {
      ...
      resists: { fire: 0, cold: 10, lightning: 5, poison: 15 },
    },
    abilities: [],
    lootTable: [],
    zoneId: 'twilight-forest',
    icon: '🐺',
    description: '暮光森林中的顶级捕食者',
  },
  fire_sprite: {
    id: 'fire_sprite',
    name: '火元素精魄',
    ...
    stats: {
      ...
      resists: { fire: 50, cold: -30, lightning: 10, poison: 20 },
    },
    abilities: [
      {
        id: 'fireball',
        name: '火球术',
        description: '发射一个火球攻击',
        triggerChance: 0.25,
        effectType: 'damage',
        effectValue: 20,
        cooldown: 4000,
  ...
  ice_shard: {
    ...
    stats: {
      ...
      resists: { fire: -30, cold: 60, lightning: 10, poison: 10 },
    },
    abilities: [
      {
        id: 'frost_nova',
        name: '冰霜新星',
        description: '释放冰冷的能量波',
        triggerChance: 0.2,
        effectType: 'damage',
        effectValue: 18,
        cooldown: 5000,
  ...
  lightning_eagle: {
    ...
    stats: {
      ...
      resists: { fire: 10, cold: 10, lightning: 50, poison: 5 },
    },
    abilities: [
      {
        id: 'lightning_bolt',
        name: '闪电箭',
        description: '快速发射一道闪电',
        triggerChance: 0.3,
        effectType: 'damage',
        effectValue: 25,
        cooldown: 3000,
  ...
  corrupted_tree: {
    ...
    stats: {
      ...
      resists: { fire: -20, cold: 20, lightning: 20, poison: 40 },
    },
    abilities: [
      {
        id: 'entangle',
  ...
  ancient_golem: {
    ...
    stats: {
      ...
      resists: { fire: 30, cold: 30, lightning: 30, poison: 20 },
    },
    abilities: [
      {
        id: 'stone_slam',
        name: '巨石冲击',
        description: '重击地面造成范围伤害',
        triggerChance: 0.2,
        effectType: 'damage',
        effectValue: 35,
        cooldown: 6000,
  ...
  plague_rat: {
    ...
    stats: {
      ...
      expReward: 85,
      goldReward: { min: 50, max: 100 },
      resists: { fire: -10, cold: 0, lightning: 0, poison: 60 },
    },
    abilities: [
      {
        id: 'plague_bite',
        name: '瘟疫撕咬',
        description: '攻击附带瘟疫效果',
        triggerChance: 0.3,
        effectType: 'debuff',
        effectValue: 15,
        cooldown: 4000,
  ...
  shadow_assassin: {
    ...
    stats: {
      ...
      resists: { fire: 10, cold: 10, lightning: 10, poison: 30 },
    },
    abilities: [
      {
        id: 'backstab',
        name: '背刺',
        description: '从阴影中发动致命一击',
        triggerChance: 0.25,
        effectType: 'damage',
        effectValue: 45,
        cooldown: 5000,
  ...
  cursed_knight: {
    ...
    stats: {
      ...
      resists: { fire: -30, cold: 40, lightning: 20, poison: 50 },
    },
    abilities: [
      {
        id: 'dark_strike',
        name: '暗影打击',
        description: '诅咒之剑造成额外伤害',
        triggerChance: 0.2,
        effectType: 'damage',
        effectValue: 40,
        cooldown: 4000,
  ...
  demon_hunter: {
    ...
    stats: {
      ...
      expReward: 150,
      goldReward: { min: 100, max: 200 },
      resists: { fire: 40, cold: 0, lightning: 20, poison: 10 },
    },
    abilities: [
      {
        id: 'demon_arrow',
        name: '恶魔箭雨',
        description: '召唤恶魔之力射出箭矢',
        triggerChance: 0.25,
        effectType: 'damage',
        effectValue: 50,
        cooldown: 5000,
    ...
    lootTable: [],
    zoneId: 'demon-fortress',
    icon: '🏹',
    description: '与恶魔签订契约的堕落猎手',
  },
  hellfire_imp: {
    id: 'hellfire_imp',
    name: '狱火小鬼',
    ...
    stats: {
      ...
      resists: { fire: 60, cold: -40, lightning: 10, poison: 20 },
    },
    abilities: [
      {
        id: 'hellfire_blast',
  ...
  pit_fiend: {
    ...
    stats: {
      ...
      resists: { fire: 50, cold: 10, lightning: 20, poison: 30 },
    },
    abilities: [
      {
        id: 'infernal_roar',
    ...
    zoneId: 'demon-fortress',
    icon: '👹',
    description: '深渊中诞生的恐怖巨兽',
  },

  // === 第二章 BOSS ===
  forest_spirit_queen: {
    id: 'forest_spirit_queen',
    name: '森林精灵女王',
    type: MonsterType.BOSS,
    level: 18,
    stats: {
      ...
      resists: { fire: 20, cold: 40, lightning: 30, poison: 50 },
    },
    abilities: [
      {
        id: 'nature_wrath',
        name: '自然之怒',
        description: '召唤自然力量攻击',
        triggerChance: 0.3,
        effectType: 'damage',
        effectValue: 60,
        cooldown: 8000,
    ...
    lootTable: [
      { itemId: 'forest_spirit_staff', chance: 0.3, minQuantity: 1, maxQuantity: 1 },
      { itemId: 'nature_blessing_robe', chance: 0.25, minQuantity: 1, maxQuantity: 1 },
    ],
    zoneId: 'twilight-forest',
    icon: '👸',
    description: '暮光森林的守护者和统治者',
  },
  plague_lord: {
    id: 'plague_lord',
    name: '瘟疫领主',
    ...
    stats: {
      ...
      resists: { fire: 10, cold: 10, lightning: 10, poison: 80 },
    },
    abilities: [
      {
        id: 'plague_cloud',
    ...
    lootTable: [
      { itemId: 'plague_scepter', chance: 0.3, minQuantity: 1, maxQuantity: 1 },
      { itemId: 'toxic_armor', chance: 0.25, minQuantity: 1, maxQuantity: 1 },
    ],
    zoneId: 'cursed-city',
    icon: '☠️',
    description: '瘟疫与死亡的化身',
  },
  demon_lord: {
    id: 'demon_lord',
    name: '恶魔领主',
    ...
    stats: {
      ...
      resists: { fire: 70, cold: -20, lightning: 30, poison: 40 },
    },
    abilities: [
      {
        id: 'inferno',
        name: '炼狱火海',
        description: '召唤地狱火焰席卷战场',
        triggerChance: 0.3,
        effectType: 'damage',
        effectValue: 100,
        cooldown: 8000,
    ...
    lootTable: [
      { itemId: 'demon_lord_sword', chance: 0.35, minQuantity: 1, maxQuantity: 1 },
      { itemId: 'hellfire_cape', chance: 0.3, minQuantity: 1, maxQuantity: 1 },
      { itemId: 'demon_crown', chance: 0.15, minQuantity: 1, maxQuantity: 1 },
    ],
    zoneId: 'demon-fortress',
    icon: '👿',
    description: '地狱的统治者，黑暗力量的巅峰',
  },
}
...
export const ZONES: Record<string, Zone> = {
  ...
  'twilight-forest': {
    ...
    monsters: ['forest_wolf', 'fire_sprite', 'ice_shard', 'lightning_eagle', 'corrupted_tree'],
  ...
  'cursed-city': {
    ...
    monsters: ['ancient_golem', 'plague_rat', 'shadow_assassin', 'cursed_knight'],
    bossId: 'plague_lord',
  ...
  'demon-fortress': {
    ...
    monsters: ['demon_hunter', 'hellfire_imp', 'pit_fiend'],
    bossId: 'demon_lord',
